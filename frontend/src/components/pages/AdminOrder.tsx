...
//                 <div className="w-full lg:w-3/5" style={{ height: 'calc(100vh - 200px)' }}>
//                     <CartTitle 
//                         title="Order List" 
//                         width="100%"
//                         fontSize="1.5rem"
//                         height="auto"
//                     />
//                     <div className="w-full bg-white rounded-lg shadow-lg p-6" style={{ height: 'calc(100vh - 200px)', maxHeight: 'calc(100vh - 200px)' }}>
//                         <ListOrder 
...
//                 <div className="w-full lg:w-2/5" style={{ height: 'calc(100vh - 200px)', maxHeight: 'calc(100vh - 200px)' }}>
//                     <CartTitle 
//                         title="Order Details" 
//                         width="100%"
//                         fontSize="1.5rem"
